...
<head>
    ...
    <title>Our Ice Cream Selection</title>
    <style>
...
<body class="site-body">
    <header class="site-header">
        <div class="content-wrapper">
            <h1>Découvrez notre sélection de glaces</h1>
        </div>
    </header>
    <div class="content-wrapper product-info">
        <h2>Bienvenue chez [Votre Magasin de Glaces] !</h2>
        <p>Nous offrons une large variété de glaces de différentes marques, garantissant qualité et prix compétitifs. Notre sélection répond à tous les goûts et préférences.</p>
        ...
        <ul class="features-list">
            <li><strong>Qualité garantie :</strong> Toutes nos glaces respectent les normes de qualité les plus strictes pour garantir que vous obteniez le meilleur.</li>
            ...
            <li><strong>Offres et réductions exclusives :</strong> Profitez d'offres et de réductions exclusives sur diverses glaces tout au long de l'année.</li>
        </ul>
        <h3>Pourquoi acheter chez nous :</h3>
        <p>Nous proposons des glaces de haute qualité à des prix compétitifs.</p>
        <p>Notre service de livraison rapide garantit que les glaces arrivent chez vous à temps et en parfait état.</p>
        ...
        <video controls>
            <source src="icecream1.mp4" type="video/mp4">
            Your browser does not support the video tag.
        </video>
        <video controls>
            <source src="icecream2.mp4" type="video/mp4">
            Your browser does not support the video tag.
        </video>
        <video controls>
            <source src="icecream3.mp4" type="video/mp4">
            Your browser does not support the video tag.
        </video>
